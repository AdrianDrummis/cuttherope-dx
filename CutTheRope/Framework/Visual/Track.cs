        ...
        private void InitKeyFrameStepFromTowithTime(KeyFrame src, KeyFrame dst, float time)
        {
            ...
            switch (type)
            {
                ...
                case TrackType.TRACK_COLOR:
                    ...
                    currentStepPerSecond.value.color.rgba.Alpha = (dst.value.color.rgba.Alpha - src.value.color.rgba.Alpha) / keyFrameTimeLeft;
                    break;
                    ...
                    case TrackType.TRACK_COLOR:
                        {
                            ...
                            currentStepAcceleration.value.color.rgba.Alpha = currentStepPerSecond.value.color.rgba.Alpha / keyFrameTimeLeft;
                            if (dst.transitionType == KeyFrame.TransitionType.FRAME_TRANSITION_EASE_IN)
                            {
                                ...
                                currentStepPerSecond.value.color.rgba.Alpha = 0f;
                            }
                            else
                            {
        ...
        public void SetElementFromKeyFrame(KeyFrame kf)
        {
            switch (type)
            {
                ...
                case TrackType.TRACK_COLOR:
                    ...
                    t.element.color.Alpha = elementPrevState.value.color.rgba.Alpha + kf.value.color.rgba.Alpha;
                    return;
                case TrackType.TRACK_ACTION:
                    {
                    ...
                    case TrackType.TRACK_COLOR:
                        {
                            ...
                            color4.rgba.Alpha += thiss.currentStepAcceleration.value.color.rgba.Alpha * delta;
                            ...
                            float num16 = thiss.currentStepAcceleration.value.color.rgba.Alpha * delta;
                            ...
                            element4.color.Alpha += (keyFrame.value.color.rgba.Alpha + (num16 / 2f)) * delta;
                            break;
                        }
                    ...
                    case TrackType.TRACK_COLOR:
                        {
                            ...
                            element8.color.Alpha += thiss.currentStepPerSecond.value.color.rgba.Alpha * delta;
                            break;
                        }
